...
class WikiViews(object):
	...
	@pyramid.view.view_config(route_name='main', renderer='templates/login.pt')
	def main(self):
		pass

	@pyramid.view.view_config(route_name='login', renderer='templates/login.pt')
	@pyramid.view.forbidden_view_config(renderer='templates/login.pt')
	def login(self):
